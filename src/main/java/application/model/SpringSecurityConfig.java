...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/clubhouses/update/*").hasAnyRole("ADMIN")
                .antMatchers("/clubs/remove/*").hasRole("ADMIN")
                .antMatchers("/collections/remove/*").hasRole("ADMIN")
                .antMatchers("/clubhouses/delete/*").hasAnyRole("ADMIN")
                ...
                .antMatchers("/collections/searchCollection").hasAnyRole("USER", "ADMIN")
                .antMatchers("/clubhouses/add").hasAnyRole("USER", "ADMIN")
